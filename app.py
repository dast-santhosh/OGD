...
# Removed st.cache_data to avoid cache issues interfering with stability
    ...
    for attempt in range(max_retries):
        try:
            ...
            if attempt < max_retries - 1:
                ...
                # Use st.warning instead of st.error for the live metric fallback
                st.warning("Error fetching live data. Displaying mock data for metrics.")
                return None
    return None
...
# Fixing deprecation warning: use_column_width -> use_container_width
...
if module == "Overview":
    ...
    # st_folium should correctly display the map
